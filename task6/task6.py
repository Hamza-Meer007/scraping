...
with open('data.jsonl', 'w') as f:
    with sync_playwright() as p:
        ...
        # lists = main_div.find_all('div')[1].find('ul', class_='pagination pagination-sm')
        # view_100_li = lists.find_all('li')[0]
        # next_li = lists.find_all('li')[4]
        # print(next_li)
        
            
        view_100_link = page.locator("#ZZ_PUBSRCH_VW\\$hviewall\\$0")
        view_100_link.wait_for(state="visible", timeout=10000)
        view_100_link.click()

        page.wait_for_load_state('networkidle')
        page.wait_for_timeout(10000)

        print("Clicked the 'View 100' link")
        
        
        while page_count <218:
            page_count += 1
        ...
        # Check if there is a next page link  
            ...
            next_button = page.locator("#ZZ_PUBSRCH_VW\\$hdown\\$0")
